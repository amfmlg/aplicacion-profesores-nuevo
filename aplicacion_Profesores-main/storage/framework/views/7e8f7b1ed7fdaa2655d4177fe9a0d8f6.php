...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <!--[if BLOCK]><![endif]--><?php if(Auth::check()): ?> <!-- Verificación de autenticación -->
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <?php else: ?> <!-- Si el usuario no está autenticado -->
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        <?php echo e(__('Guest')); ?>
...
<?php endif; ?>
                            ...
                            <?php else: ?>
                                <div class="block px-4 py-2 text-xs text-gray-400">
                                    <?php echo e(__('Log In to Manage Account')); ?>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <?php else: ?> <!-- Si el usuario no está autenticado -->
                    <div>
                        <span class="font-medium text-base text-gray-800"><?php echo e(__('Guest')); ?></span>
                    </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
...
<?php /**PATH C:\Users\amfml\Desktop\aplicacion profesores\aplicacion-profesores-nuevo\aplicacion_Profesores-main\resources\views/navigation-menu.blade.php ENDPATH**/ ?>