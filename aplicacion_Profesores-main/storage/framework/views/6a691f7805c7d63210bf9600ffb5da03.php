    ...
    <header class="flex justify-between items-center mb-6">
        ...
        <nav>
            <ul class="flex space-x-4">
                <li><a href="<?php echo e(route('dashboard')); ?>" class="text-blue-600">Dashboard</a></li>
                <li><a href="<?php echo e(route('courses.index')); ?>" class="text-blue-600">Cursos</a></li>
                <li><a href="<?php echo e(route('logout')); ?>" class="text-blue-600">Cerrar sesión</a></li>
            </ul>
        </nav>
    </header>
...
<?php /**PATH C:\Users\amfml\Desktop\aplicacion profesores\aplicacion-profesores-nuevo\aplicacion_Profesores-main\resources\views/home.blade.php ENDPATH**/ ?>